    ...
    <body>
        ...
        <div id="doll">
            ...
            <div id="animal">
                ...
                <div id="cat">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_cat" value="cat">ねこ（ノーマル）</div>
                        <div><input type="radio" name="input_cat" value="cat_smile">ねこ（笑顔）</div>
                    </div>
                </div>
       ...
       　  　     <select id="selbox" onchange="change();">
            ...
            　　<div id="mouse">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_mouse" value="mouse">子（ねずみ・ノーマル）</div>
            ...
            　　<div id="cow" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_cow" value="cow">丑（うし・ノーマル）</div>
            ...
            　　<div id="tiger" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_tiger" value="tiger">寅（とら・ノーマル）</div>
            ...
            　　<div id="rabbit" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_rabbit" value="rabbit">卯（うさぎ・ノーマル）</div>
            ...
            　　<div id="dragon" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_dragon" value="dragon">辰（龍・ノーマル）</div>
            ...
            　　<div id="snake" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_snake" value="snake">巳（へび・ノーマル）</div>
            ...
            　　<div id="horse" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_horse" value="horse">午（うま・ノーマル）</div>
            ...
            　　<div id="sheep" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_sheep" value="sheep">未（ひつじ・ノーマル）</div>
            ...
            　　<div id="monkey" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_monkey" value="monkey">申（さる・ノーマル）</div>
            ...
            　　<div id="bird" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_bird" value="bird">酉（とり・ノーマル）</div>
            ...
            　　<div id="dog" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_dog" value="dog">戌（いぬ・ノーマル）</div>
            ...
            　　<div id="boar" style="display:none">
                    ...
                    <div class="input">
                        <div><input type="radio" name="input_boar" value="boar">亥（いのしし・ノーマル）</div>
        ...
        <a href="/goods"><button type="button">確定</button></a>
