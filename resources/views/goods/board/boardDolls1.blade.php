    ...
    <body>
        ...
        <form action="/board" method="GET">
            ...
            <div id="dolls">
                ...
                <div clss="category">
                    <h3>カテゴリー</h3>
                    <select id="dolls_type" name="input1" onchange="DollsTypeCange();">
                ...
                <div id="animal">
                    ...
                    <div id="cat">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="cat">ねこ（ノーマル）</div>
                            <div><input type="radio" name="input2" value="cat_smile">ねこ（笑顔）</div>
                        </div>
                    </div>
                    ...
                    <div id="turtle" style="display:none">
                        <div class="turtle">
                            ...
                            <div class="input">
                                <div><input type="radio" name="input2" value="turtle">かめ</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="owl" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="owl">ふくろう</div>
                        </div>
                    </div>
                </div>
           ...
           　  　     <select id="selbox" onchange="change();">
                ...
                　　<div id="mouse">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="mouse">子（ねずみ・ノーマル）</div>
                            <div><input type="radio" name="input2" value="mouse_smile">子（ねずみ・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="cow" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="cow">丑（うし・ノーマル）</div>
                            <div><input type="radio" name="input2" value="cow_smile">丑（うし・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="tiger" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="tiger">寅（とら・ノーマル）</div>
                            <div><input type="radio" name="input2" value="tiger_smile">寅（とら・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="rabbit" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="rabbit">卯（うさぎ・ノーマル）</div>
                            <div><input type="radio" name="input2" value="rabbit_smile">卯（うさぎ・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="dragon" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="dragon">辰（龍・ノーマル）</div>
                            <div><input type="radio" name="input2" value="dragon_smile">辰（龍・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="snake" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="snake">巳（へび・ノーマル）</div>
                            <div><input type="radio" name="input2" value="snake_smile">巳（へび・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="horse" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="horse">午（うま・ノーマル）</div>
                            <div><input type="radio" name="input2" value="horse_smile">午（うま・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="sheep" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="sheep">未（ひつじ・ノーマル）</div>
                            <div><input type="radio" name="input2" value="sheep_smile">未（ひつじ・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="monkey" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="monkey">申（さる・ノーマル）</div>
                            <div><input type="radio" name="input2" value="monkey_smile">申（さる・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="bird" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="bird">酉（とり・ノーマル）</div>
                            <div><input type="radio" name="input2" value="bird_smile">酉（とり・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="dog" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="dog">戌（いぬ・ノーマル）</div>
                            <div><input type="radio" name="input2" value="dog_smile">戌（いぬ・笑顔）</div>
                        </div>
                　　</div>
                　　
                　　<div id="boar" style="display:none">
                        ...
                        <div class="input">
                            <div><input type="radio" name="input2" value="boar">亥（いのしし・ノーマル）</div>
                            <div><input type="radio" name="input2" value="boar_smile">亥（いのしし・笑顔）</div>
                        </div>
                　　</div>
            　　</div>
            　　
